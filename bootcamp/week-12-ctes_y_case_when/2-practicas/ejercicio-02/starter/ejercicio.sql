...
-- ============================================
-- Clasifica cada empleado activo en 'Alto' (>=70000), 'Medio' (>=50000) o 'Bajo' (resto)
...
-- ============================================
-- Mapea department_id a una etiqueta corta usando evaluación directa por igualdad
...
-- ============================================
-- Cuenta high_earners (>=70000), mid_earners (50000-69999) y low_earners (<50000) por departamento
-- Nota: Si el CASE no tiene ELSE, los registros que no cumplen devuelven NULL, y COUNT() ignora los NULLs.
...
-- La consulta principal agrupa por la nueva columna calculada 'salary_band' y calcula promedios.
